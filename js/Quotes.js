...
// console.log(quote[0 - 9]);

// // math class
// Math.random() // 0~1 사이의 수 나타냄
// 0.469009203661805
// // 끝에 붙은 float는 필요 없음
...
// Math.ceil(1.1) // 올림
// 2
// Math.floor(1.99999) //내림
// 1

// // 실제 사용할 공식
// Math.floor(Math.random()*10)
// 7
const todaysQuote = quotes[Math.floor(Math.random() * quotes.length)]; // quotes.length : array 수
